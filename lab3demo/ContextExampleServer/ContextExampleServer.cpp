...
int Summa(CONTEXT_HANDLE hContext, int result, int result2)
{
...
int main()
{
   ...
   // регистрация интерфейса
    RpcServerRegisterIf2(ContextExample_v1_0_s_ifspec,NULL,NULL, 
      ...
      RPC_C_LISTEN_MAX_CALLS_DEFAULT, // кол-во вызов к серверу по умолчанию , чтобы он быстрее работал
      (unsigned)-1, // нету ограничений на максимал. блок памяти, против вредонос. атак
      NULL);
