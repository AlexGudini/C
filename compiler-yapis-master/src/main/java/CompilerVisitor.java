...
public class CompilerVisitor extends GrammarBaseVisitor<String> {
    ...
    public String visitPlusNames(GrammarParser.PlusNamesContext ctx) {
        System.out.println("PlusR");
        String name1 = ctx.NAME().get(0).getText();
        String name2 = ctx.NAME().get(1).getText();

        String buffer = "";
        buffer +=  "new Element(" + name1 +".toString() + " + name2 +".toString());";

        return buffer;
    }

    public String visitLength(GrammarParser.LengthContext ctx) {
        String name1 = ctx.NAME().getText();

        String buffer = "";
        // new Element(ww.toString() + rr.toString());
        buffer +=  "System.out.println(" + name1 +".length());";
    ...
    public String visitPrint(GrammarParser.PrintContext ctx) {
       ...
       /* if (ctx.plusNames() != null) {
            String buffer = "";
            buffer +=  "System.out.println( new Element(" + ctx.plusNames().NAME(0).getText() +".toString() + " + ctx.plusNames().NAME(1).getText() +".toString()));";

            return buffer;
        }*/

        if (ctx.STRING() != null) {
            System.out.println("System.out.println(" + ctx.STRING().getText() + ");");
        ...
        if (ctx.NAME() != null) {
            ...
            return "System.out.println(" + s + ".toString());";
        }
       ...
       /* String er1 = "NotArgumentException";
        String error = "(" + er1 +" ) throws Exception";*/
    ...
    public String visitContent(GrammarParser.ContentContext ctx) {
        ...
        if (ctx.plusNames() != null) {
            System.out.println("visitPlusName");
            return visitPlusNames(ctx.plusNames());
        }
    ...
    public String visitForCycle(GrammarParser.ForCycleContext ctx) {
        System.out.println("visitFOrCycle");
        String name1 = ctx.equalNames().NAME(0).getText();
        String name2 = ctx.equalNames().NAME(1).getText();

        String buffer = "for(;"+ name1 + ".equals("+name2+");)";
        buffer += visitBlock(ctx.block());
        return buffer;
    }
    ...
    public String visitEqualNames(GrammarParser.EqualNamesContext ctx) {
        ...
        if( name1.equals(name2)){
            buffer += "new Element( " + name1 + " ).equals("+name2 + ")";
        }
