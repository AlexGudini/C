...
public interface GrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GrammarParser#plusNames}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPlusNames(GrammarParser.PlusNamesContext ctx);
	/**
	 * Visit a parse tree produced by {@link GrammarParser#length}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLength(GrammarParser.LengthContext ctx);
	/**
