...
public interface GrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GrammarParser#plusNames}.
	 * @param ctx the parse tree
	 */
	void enterPlusNames(GrammarParser.PlusNamesContext ctx);
	/**
	 * Exit a parse tree produced by {@link GrammarParser#plusNames}.
	 * @param ctx the parse tree
	 */
	void exitPlusNames(GrammarParser.PlusNamesContext ctx);
	/**
	 * Enter a parse tree produced by {@link GrammarParser#length}.
	 * @param ctx the parse tree
	 */
	void enterLength(GrammarParser.LengthContext ctx);
	/**
	 * Exit a parse tree produced by {@link GrammarParser#length}.
	 * @param ctx the parse tree
	 */
	void exitLength(GrammarParser.LengthContext ctx);
	/**
